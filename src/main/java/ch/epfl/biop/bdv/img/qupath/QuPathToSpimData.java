        ...
        try {
            ...
            spimDataMap.keySet().forEach(spimUri->{
                ...
                if (pixelCalibrations!=null) {
                    ...
                    Length[] voxSizes = BioFormatsTools.getSeriesVoxelSizeAsLengths(qpOpener.getOmeMetaIdxOmeXml(), identifier.bioformatsIndex);
                    if (pixelCalibrations.pixelWidth!=null) {
                        ...
                        if ((voxSizes[0]!=null)&&(voxSizes[0].value(UNITS.MICROMETER)!=null)) {
                            ...
                            Length defaultxPix = new Length(1, BioFormatsTools.getUnitFromString(guiparams.getUnit()));
