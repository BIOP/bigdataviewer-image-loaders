...
public class OmeroBdvOpener {
    ...
    protected static Logger logger = LoggerFactory.getLogger(OmeroBdvOpener.class);
   ...
   // protected transient Consumer<IFormatReader> readerModifier = (e) -> {};
    ...
    public OmeroBdvOpener positionReferenceFrameLength(ome.units.quantity.Length l) {
        this.positionReferenceFrameLength = l;
        return this;
    }

    public OmeroBdvOpener voxSizeReferenceFrameLength(ome.units.quantity.Length l) {
    ...
    public static OmeroBdvOpener getOpener() {
        OmeroBdvOpener opener = new OmeroBdvOpener()
