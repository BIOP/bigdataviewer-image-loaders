...
public class OmeroImageLoader implements ViewerImgLoader, MultiResolutionImgLoader, Closeable {
     ...
     * @throws Exception
     */
    public OmeroImageLoader(List<OmeroBdvOpener> openers, final AbstractSequenceDescription<?, ?, ?> sequenceDescription, int numFetcherThreads, int numPriorities) throws Exception {
